...
namespace WindowsFormsApp15
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            _voice.Text = "جنسیت دختر بزن  جفت رو بزن سفالیک";

            _ocr.Text = @"[ , BPD  ,  84.24 mm GA 33w6d±22d EDD 2026-11-01 2]
[ , HC  ,  304.37 mm GA 33w6d±21d15 EDD 2026-11-01]
[ , FL ,  304.37 mm GA 34w0d±21 EDD 2026-11-03]";

            _normal.Text = @"سونوگرافی بارداری:

یک ساک بارداری با نمای طبیعی در حفره رحم دیده شد.

یک جنین زنده با حرکات سوماتیک و ضربان قلب طبیعی درون ساک بارداری رویت شد.
( FHR = {FHR}     bpm )

BPD =  {BPD}mm   {BPD.GA}~1d    FL =  {FL.GA}   {FL}mm    AC = {AC}    HC=  {HC.GA}    {HC}                    

پرزانتاسیون جنین {Presentation} است.

جفت در موقعیت                     با نمای متناسب با سن بارداری و با فاصله مناسب از سرویکس دیده شد.

شواهد سونوگرافیک به نفع دکولمان، هماتوم خلف جفت و
چسبندگی غیرطبیعی جفت رویت نگردید.

حجم مایع آمنیوتیک متناسب با سن بارداری و در حد طبیعی است.
( AFI =                         )

وزن تقریبی جنین حدود                         است که نزدیک به صدک
منحنی رشد استاندارد جنین است.

سن بارداری براساس سونوگرافی سه ماهه اول حدود
                         است.

Sex = {Sex}

توجه:
این سونوگرافی شامل بررسی آنومالی‌های جنین نمی‌باشد.

در این مرکز سونوگرافی هفته اول (آنومالی اسکن)، سونوگرافی سه بعدی و
چهار بعدی، نوار قلب جنین (NST) و اکوکاردیوگرافی جنین قابل انجام است.";
        }
